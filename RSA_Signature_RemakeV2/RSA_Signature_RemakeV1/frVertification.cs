...
namespace RSA_Signature_RemakeV1
{
    public partial class frVertification : Form
    {
        ...
        private void ReadSignatureZipFile(string path)
        {
                    ...
                    foreach (ZipArchiveEntry entry in archive.Entries)
                        {
                                ...
                                || (!entry.FullName.EndsWith(".xml", StringComparison.OrdinalIgnoreCase)))
                            {
                                ...
                                string entryOutputPath3 = Path.Combine(extractPath, entry.FullName.Replace(".qvst", ""));
            ...
            {
                MessageBox.Show("Error! The file inserted is not a zip file or not right method zip!");
            }
            #endregion
        }
        }
